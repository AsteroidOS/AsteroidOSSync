...
class MessageRepositoryImpl : MessageRepository {
    private val _requestSetDeviceFlow = MutableStateFlow<BluetoothDevice?>(null)

    override val requestSetDeviceFlow: Flow<BluetoothDevice> =
    ...
    override val requestUnsetDeviceFlow: MutableStateFlow<Int> = MutableStateFlow(0)

    override fun requestUnsetDevice() {
        requestUnsetDeviceFlow.value = requestUnsetDeviceFlow.value++
    }

    override val requestUpdateDeviceFlow: MutableStateFlow<Int> = MutableStateFlow(0)

    override fun requestUpdateDevice() {
        requestUpdateDeviceFlow.value = requestUpdateDeviceFlow.value++
    }

    override val requestConnectFlow: MutableStateFlow<Int> = MutableStateFlow(0)

    override fun requestConnect() {
        requestConnectFlow.value = requestConnectFlow.value++
    }

    override val requestDisconnectFlow: MutableStateFlow<Int> = MutableStateFlow(0)

    override fun requestDisconnect() {
        requestDisconnectFlow.value = requestDisconnectFlow.value++
    }

    override val requestBatteryLifeFlow: MutableStateFlow<Int> = MutableStateFlow(0)
